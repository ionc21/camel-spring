...
@org.springframework.test.context.ContextConfiguration(classes = { ABCFulfillmentCenterRouterTest.TestConfig.class }, loader = org.apache.camel.test.spring.CamelSpringDelegatingTestContextLoader.class)
public class ABCFulfillmentCenterRouterTest {
	...
	public static String fulfillmentCenterMessage1 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
			...
			+ com.pluralsight.orderfulfillment.generated.FulfillmentCenter.ABC_FULFILLMENT_CENTER.value() + "</FulfillmentCenter>" + "<OrderItems>"
			+ "<ItemNumber>078-1344200444</ItemNumber>" + "<Price>20.00000</Price>" + "<Quantity>1</Quantity>" + "</OrderItems>" + "</OrderType>" + "</Order>";

	public static String fulfillmentCenterMessage2 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
			+ "<Order xmlns=\"http://www.pluralsight.com/orderfulfillment/Order\">" + "<OrderType>" + "<FirstName>Larry</FirstName>"
			+ "<LastName>Horse</LastName>" + "<Email>larry@somehow.com</Email>" + "<OrderNumber>1004</OrderNumber>"
			+ "<TimeOrderPlaced>2014-10-24T12:09:21.330-05:00</TimeOrderPlaced>" + "<FulfillmentCenter>"
			+ com.pluralsight.orderfulfillment.generated.FulfillmentCenter.ABC_FULFILLMENT_CENTER.value() + "</FulfillmentCenter>" + "<OrderItems>"
			+ "<ItemNumber>078-1344200445</ItemNumber>" + "<Price>21.00000</Price>" + "<Quantity>1</Quantity>" + "</OrderItems>" + "</OrderType>" + "</Order>";

	public static String fulfillmentCenterMessage3 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
			+ "<Order xmlns=\"http://www.pluralsight.com/orderfulfillment/Order\">" + "<OrderType>" + "<FirstName>Michael</FirstName>"
			+ "<LastName>Tester</LastName>" + "<Email>mtestersomehow.com</Email>" + "<OrderNumber>1005</OrderNumber>"
			+ "<TimeOrderPlaced>2014-10-24T12:09:21.330-05:00</TimeOrderPlaced>" + "<FulfillmentCenter>"
			+ com.pluralsight.orderfulfillment.generated.FulfillmentCenter.ABC_FULFILLMENT_CENTER.value() + "</FulfillmentCenter>" + "<OrderItems>"
			+ "<ItemNumber>078-1344200446</ItemNumber>" + "<Price>22.00000</Price>" + "<Quantity>1</Quantity>" + "</OrderItems>" + "</OrderType>" + "</Order>";

	public static String fulfillmentCenterMessage4 = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
			+ "<Order xmlns=\"http://www.pluralsight.com/orderfulfillment/Order\">" + "<OrderType>" + "<FirstName>Jane</FirstName>"
			+ "<LastName>Smith</LastName>" + "<Email>jane@somehow.com</Email>" + "<OrderNumber>1003</OrderNumber>"
			+ "<TimeOrderPlaced>2014-10-24T12:09:21.330-05:00</TimeOrderPlaced>" + "<FulfillmentCenter>"
		...
		public RouteBuilder route() {
			return new RouteBuilder() {
				...
				public void configure() throws Exception {
					...
					from("activemq:queue:ABC_FULFILLMENT_REQUEST").aggregate(new ABCFulfillmentCenterAggregationStrategy())
							.xpath("//*[contains(text(), '" + FulfillmentCenter.ABC_FULFILLMENT_CENTER.value() + "')]", String.class, namespace)
							.completionInterval(10000).beanRef("aBCFulfillmentProcessor", "processAggregate").marshal().csv()
							.to("file://C:/dev/abcfulfillmentcenter/out?fileName=abcfc-" + dateString + ".csv")
							.setHeader("CamelFileName", constant("abcfc-" + dateString + ".csv")).to("sftp://localhost:22?username=test&password=test")
